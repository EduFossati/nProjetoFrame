        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(!is_null($pes->cpf)){echo 'PF';}
                        else {echo 'PJ';}?>
                        <a href="<?php echo base_url(). 'pessoa/editar/' . $pes->idPessoa?>">Editar</a>
                        <a href="<?php echo base_url(). 'pessoa/excluir/' . $pes->idPessoa?>">Excluir</a>
                    </td>
                </tr>                
                <?php endforeach;?>
            </tbody>
